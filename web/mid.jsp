...
<title>Examination System</title>
 ...
 var url;
 function main(){
 document.getElementById('first').src ="result_sys.jsp" ;
 }
...
<div class="wrap">
  ...
  <button style="position:absolute;top:80px;left:10px" onclick="profile('schedules.jsp')" class="button">Schedules</button>
